...
def detect():
	with MS.MicrophoneStream(RATE, CHUNK) as stream:
		...
		for content in audio_generator:
			...
			if (rc == 1):
				#MS.play_file("../python3/ex_wav_data/hi_friend_please_tell_your_story.wav")
				
				MS.play_file("../python3/ex_wav_data/hi_friend.wav")
				MS.play_file("../python3/ex_wav_data/what_happend.wav") # better!
...
def btn_detect():
	...
	with MS.MicrophoneStream(RATE, CHUNK) as stream:
		...
		for content in audio_generator:
			...
			if (rc == 1):
				GPIO.output(31, GPIO.HIGH)
				MS.play_file("../python3/mynameis.wav")
				return 200
