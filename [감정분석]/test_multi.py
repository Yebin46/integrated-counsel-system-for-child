...
def main(args):
    ...
    for sample in range(sample_num):
        ...
        print("nplogit_1d type: ", type(nplogit_1d))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default='./data/emotional dataset')
    parser.add_argument('--bert_path', type=str, default='./KoBERT')
    parser.add_argument('--model_path', type=str, default='./practice/epoch10-loss0.0388-f11.0000.bin')
